...
export interface ThrottleAsyncOptionsInput {
  ...
  useFactory: (...args: unknown[]) => ThrottleFactoryValue | Promise<ThrottleFactoryValue>;
}
 ...
 */
export function throttleAsyncOptions(opts: ThrottleAsyncOptionsInput): ThrottlerAsyncOptions {
  return {
